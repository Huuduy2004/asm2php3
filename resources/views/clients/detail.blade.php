    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{asset('/storage/'. $pr->image)}}" alt="Image">
                        </div>
                        {{-- <div class="carousel-item">
                            <img class="w-100 h-100" src="{{asset('clients/img/product-2.jpg')}}" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{asset('clients/img/product-3.jpg')}}" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{asset('clients/img/product-4.jpg')}}" alt="Image">
                        </div> --}}
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">{{ $pr->title }}</h3>
                ...
                <span class="text-dark font-weight-medium mb-0 mr-3">Category:</span>
                @foreach ($category as $cateName)
                    <span>
                        @if ($cateName->id == $pr->category_id)
                            {{ $cateName->name }}
                        @endif
                    </span>
                @endforeach
